  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      @endif
        ...
        {!! Form::model($item, ['method' => 'PATCH','route' => ['EmpleadosCrud.update', $item->id]]) !!}
      {{ csrf_field() }}
      <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                  ...
                  {!! Form::textarea('apellidos', null, array('class' => 'form-control','style'=>'height:50px')) !!}
              </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                  ...
                  {!! Form::email('codigop', null, array('class' => 'form-control')) !!}
              </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="form-group">
                  <strong>Telefono de emergencias:</strong>
